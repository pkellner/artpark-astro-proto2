...
export const NavItems = [
  {
    ...
    slug: "/",
    description:
      "Our ArtPark Home Page",
  },
  {
    name: "About",
    slug: "/about",
    description: "Everything about touring the ArtPark.",
  },
];
...
const KeystaticBanner = () => {
  return (
    <div className="py-3 external-link bg-black text-white fill-white text-center text-sm">
      You're looking at phase 0 of the ArtPark Walk-about app... Stay tuned for much more to come!
...
const Header = () => {
  const pathname = "/mypath-no-idea-201"; // usePathname();
