      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className=" flex flex-col gap-6 md:flex-row justify-between items-center max-w-7xl px-5 md:px-10 text-center md:text-left external-link">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <p className="text-sm">
              &copy; {new Date().getFullYear()} Borrego High School Kids. All rights reserved.
            </p>
          </div>
          <p className="text-sm">
            Made with <span className="text-[#ff3838]">♥</span> in Borrego Springs by <span className="font-medium">the kids</span>
          </p>
        </div>
      </div>
    </footer>
